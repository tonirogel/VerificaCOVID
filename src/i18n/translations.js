export var translations = {
    ...
    "We don't save data": {
        ...
        "fr": "Nous ne conservons pas les données",
    ...
    "No installs": {
        ...
        "fr": "Pas d'installation nécessaire",
    ...
    "$callus": {
        ...
        "fr": "Si vous êtes une organisation publique ou une entreprise privée et que vous souhaitez en savoir plus sur cette solution ou d'autres solutions similaires d'Evidence Ledger, vous pouvez nous contacter par e-mail.",
        "de": "Wenn Sie eine öffentliche oder private Organisation sind und weitere Informationen über diese oder ähnliche Lösungen von Evidence Ledger wünschen, können Sie uns per E-Mail kontaktieren.",
    ...
    "Application updated": {
        ...
        "ca": "Aplicació actualitzada",
        "fr": "Application mise à jour",
        "de": "Anwendung aktualisiert",
        "it": "L'applicazione è stata aggiornata"
    },
    "There is a new version of the application and it has already been updated.": {
        "es": "Se ha actualizado con una nueva versión de la aplicación.",
        "ca": "Actualitzat amb una nova versió de l'aplicació.",
        "fr": "Il existe une nouvelle version de l'application et elle a déjà été mise à jour.",
        "de": "Es gibt eine neue Version der Anwendung und sie ist bereits aktualisiert worden.",
        "it": "Una nuova versione dell'applicazione è disponibile ed è già stata aggiornata."
    },
    "Please click Accept to refresh the page.": {
        "es": "Por favor presione Aceptar para refrescar la página",
        "ca": "Premeu Acceptar per actualitzar la pàgina",
        "fr": "Veuillez cliquer sur Accepter pour rafraîchir la page.",
    ...
    "Certificate is not yet valid as vaccination is too recent.": {
        ...
        "ca": "Certificat no vàlid perquè la vacunació és massa recent.",
    },
    "Signature validation failed. The certificate is not valid.": {
        "es": "Error en verificación de firma. Certificado inválido",
        "ca": "Signature validation failed. The certificate is not valid.",
        "fr": "La validation de la signature a échoué. Le certificat n'est pas valable.",
    ...
    "The certificate is valid.": {
        ...
        "ca": "El certificat és vàlid",
        "fr": "Le certificat est valable.",
        "de": "Das Zertifikat ist gültig.",
        "it": "Il certificato è valido."
    },

    "EU DIGITAL COVID CERTIFICATE": {
        "es": "CERTIFICADO COVID DIGITAL DE LA EU",
        "ca": "CERTIFICAT COVID DIGITAL DE LA EU",
        "fr": "CERTIFICAT NUMÉRIQUE COVID DE L'UE",
    ...
    "$help03": {
        "es": "Permitir el acceso a la cámara cuando así lo solicite la aplicación \u0022VerificaCovid.ibsalut.es\u0022.",
        "ca": "Permetre l'accés a la càmera quan així ho sol·liciti l'aplicació \u0022VerificaCovid.ibsalut.es\u0022.",
        "en": "Allow access to the camera when requested by the \u0022VerificaCovid.ibsalut.es\u0022 application.",
        "fr": "Autoriser l'accès à la caméra à la demande de l'application \u0022VerificaCovid.ibsalut.es\u0022.",
        "de": "Erlauben Sie den Zugriff auf die Kamera, wenn Sie von der Anwendung \u0022VerificaCovid.ibsalut.es\u0022 angefordert werden.",
        "it": "Consenti l'accesso alla telecamera quando richiesto dall'applicazione \u0022VerificaCovid.ibsalut.es\u0022."
    },
    "$help04": {
