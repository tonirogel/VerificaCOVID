...
function initialHeader() {
    ...
    <div class="hidden pl-6 bg-gray-gene" id="mobileMenu">
        <a class="block text-white text-lg py-2" onclick='gotoPage("refreshKeys")' href="javascript:void(0)">${T("Update public keys")}</a>
        <a class="block text-white text-lg py-2" onclick='gotoPage("selectLanguage")' href="javascript:void(0)">${T("Language")}</a>
        <a class="block text-white text-lg py-2" onclick='gotoPage("selectCamera")' href="javascript:void(0)">${T("Camera")}</a>
    </div>
`
